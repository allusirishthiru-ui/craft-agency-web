      ...
      <div className="container relative z-10 px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold text-gradient mb-4">GrowthGrid</h3>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              A fresh start in digital marketing. No experience needed – we grow together with innovative solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground">growthgrid@gmail.com</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary" />
                <span className="text-muted-foreground">+91 6281892355</span>
              </li>
        ...
        <div className="pt-8 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © 2024 GrowthGrid. All rights reserved.
          </p>
